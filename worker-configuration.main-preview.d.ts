/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.main-preview.jsonc worker-configuration.main-preview.d.ts` (hash: 3a795ddda306bf91f65486782d8d0065)
